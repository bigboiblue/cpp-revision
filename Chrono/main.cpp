...
int main() {
    ...
    //  (which on my machine happens to be nanoseconds)
    ...
    //This is included in #include ratio (which is included in chrono).
    // std::chrono::duration<count type, tick period>  <--- args
    //std::chrono::milliseconds is an alias for std::chrono::duration< long, std::milli>
